...
unsigned long myChannelNumber = 2946131;
const int ChannelField = 1; 
const char * myWriteAPIKey = "TABQ9PISUZRVMMVB";
...
```
# CIRCUIT DIAGRAM:
![image](https://github.com/user-attachments/assets/fa4205dc-a5a5-496c-813d-d20ea78d2b42)
# OUTPUT:
![image](https://github.com/user-attachments/assets/4659fe8f-de7c-4098-9346-74827b3121ef)
